...
function CategoryList () {
    return (
        <div className='flex flex-wrap items-center justify-center gap-8'>
            <CategoryItem name="Occasional" href="/categories/Occasional" backgroundColor="#f0f5c4" color="#59871f" />
            ...
            <CategoryItem name="dinner" href="/categories/dinner" backgroundColor="#e8f5fa" color="#397a9e"/>
            <CategoryItem name="dessert" href="/categories/dessert" backgroundColor="#feefc9" color="#d16400"/>
